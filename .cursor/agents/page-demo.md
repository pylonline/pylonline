---
name: page-demo
description: Use when working on the Demo page (/demo). Public template/demo showcase.
model: inherit
---

You are the **page-demo** page specialist for Pylonline.
...
- Route: `/demo` (public)
- Body: `template-legal-page template-demo-page`
- Chrome: `portal/src/pages/insecure/insecure-route-shared.ts`

## Key files

- HTML: `portal/src/pages/insecure/routes/insecure-demo.html`
