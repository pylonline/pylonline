---
name: page-about
description: Use when working on the About page (/about). Public about copy on the legal/content card.
model: inherit
---

You are the **page-about** page specialist for Pylonline.
...
- Route: `/about` (public)
- Body: `template-legal-page template-about-page`
- Chrome: `portal/src/pages/insecure/insecure-route-shared.ts`

## Key files

- HTML: `portal/src/pages/insecure/routes/insecure-about.html`
...
2. Prefer contract legal/content styles over a new route-override.
